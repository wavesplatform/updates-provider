use super::ConfigsFromGitlabRepo;
...
pub struct ConfigsFromGitlabRepoImpl {
...
impl ConfigsFromGitlabRepoImpl {
    pub fn new(
...
#[async_trait]
impl ConfigsFromGitlabRepo for ConfigsFromGitlabRepoImpl {
